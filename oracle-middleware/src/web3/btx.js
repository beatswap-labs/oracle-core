...
router.post("/allowance", async (req, res) => {
  ...
  try {
    console.log("Contract Address:", btxUrl);
    console.log("Network:", MAIN_RPC_URL);
    const btxContract = new mweb3.eth.Contract(btxAbi, btxUrl);

    const owner = req.body.owner;
    const spender = req.body.spender;

    const result = await btxContract.methods.allowance(owner, spender).call();
    
    if (result !== null && result !== undefined) {

      res.json({ allowance: result.toString() });
    } else {
