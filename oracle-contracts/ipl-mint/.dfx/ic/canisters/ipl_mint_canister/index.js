...
import { idlFactory } from './ipl_mint_canister.did.js';
export { idlFactory } from './ipl_mint_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IPL_MINT_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ipl_mint_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ipl_mint_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ipl_mint_canister.did.js")._SERVICE>}
 */
export const ipl_mint_canister = createActor(canisterId);
