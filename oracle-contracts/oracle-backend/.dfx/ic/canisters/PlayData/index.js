...
import { idlFactory } from './PlayData.did.js';
export { idlFactory } from './PlayData.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PLAYDATA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./PlayData.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the PlayData canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./PlayData.did.js")._SERVICE>}
 */
export const PlayData = createActor(canisterId);
