...
import { idlFactory } from './MemberSnap.did.js';
export { idlFactory } from './MemberSnap.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MEMBERSNAP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MemberSnap.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MemberSnap canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MemberSnap.did.js")._SERVICE>}
 */
export const MemberSnap = createActor(canisterId);
