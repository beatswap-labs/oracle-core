...
import { idlFactory } from './UserUnlock.did.js';
export { idlFactory } from './UserUnlock.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USERUNLOCK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./UserUnlock.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the UserUnlock canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./UserUnlock.did.js")._SERVICE>}
 */
export const UserUnlock = createActor(canisterId);
