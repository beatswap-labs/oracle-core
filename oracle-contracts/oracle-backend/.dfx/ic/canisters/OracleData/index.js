...
import { idlFactory } from './OracleData.did.js';
export { idlFactory } from './OracleData.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ORACLEDATA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./OracleData.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the OracleData canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./OracleData.did.js")._SERVICE>}
 */
export const OracleData = createActor(canisterId);
