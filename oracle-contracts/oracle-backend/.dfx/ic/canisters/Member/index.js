...
import { idlFactory } from './Member.did.js';
export { idlFactory } from './Member.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MEMBER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Member.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Member canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Member.did.js")._SERVICE>}
 */
export const Member = createActor(canisterId);
