...
import { idlFactory } from './DailyHoldersData.did.js';
export { idlFactory } from './DailyHoldersData.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DAILYHOLDERSDATA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./DailyHoldersData.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the DailyHoldersData canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./DailyHoldersData.did.js")._SERVICE>}
 */
export const DailyHoldersData = createActor(canisterId);
