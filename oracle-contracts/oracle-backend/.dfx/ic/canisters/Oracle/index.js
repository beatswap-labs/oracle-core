...
import { idlFactory } from './Oracle.did.js';
export { idlFactory } from './Oracle.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ORACLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Oracle.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Oracle canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Oracle.did.js")._SERVICE>}
 */
export const Oracle = createActor(canisterId);
