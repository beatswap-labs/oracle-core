...
import { idlFactory } from './OracleData2.did.js';
export { idlFactory } from './OracleData2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ORACLEDATA2;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./OracleData2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the OracleData2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./OracleData2.did.js")._SERVICE>}
 */
export const OracleData2 = createActor(canisterId);
