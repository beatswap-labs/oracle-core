...
import { createActor } from 'declarations/Oracle';
import { canisterId } from 'declarations/Oracle/index.js';
...
const App = () => {
  const [state, setState] = useState({
    ...
    principal: 'Click "Myoracle" to see your principal ID'
  });
    ...
    <div>
      ...
      <div id="info-box" className="info-box">
        <div className="info-content">
          ...
          <p>
            In this page, click "Whoami" to find out the principal ID with which you're interacting with the backend.
          ...
          <p>
            ...
            identity and the oracle you're using.
          </p>
        </div>
      </div>

      {!state.isAuthenticated ? (
        <Button onClick={login}>Login oracle with Internet Identity</Button>
      ) : (
      ...
      {state.principal && (
        <div>
          <h2>Your oracle principal ID is:</h2>
